...
**Version:** 3.8.5 Multi-Action System with State Threading & Probabilistic Events
**Last Updated:** February 8, 2026
**Status:** Production Ready - All State Fixes Applied
...
## Latest Improvements: v3.8.2 - v3.8.5 (February 2026)
...
- **v3.8.5** (Current - February 8, 2026) - State threading for multi-action factions, sequential execution preserving ~30 direct mutations, synergies/contradictions/GDP/territory applied directly to threaded state
...
**Status:** v3.8.5 - All state fixes applied (state threading, probabilistic events, prompt pipeline). Simulation needs re-run to generate corrected data.
